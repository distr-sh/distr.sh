...
publishDate: 2026-02-17T12:00:00
lastUpdated: 2026-02-17T12:00:00
slug: 'distr-alerts'
authors:
  - name: 'Louis Weston'
    role: 'Co-Founder'
...
For customers that manage and update the deployments themselves, you can enable alerts for them as well so they can configure their own alerts.
...
If you're not using Distr yet and you're dealing with software distribution to on-prem or customer-controlled infrastructure... well, we should probably talk. [Try it here](https://distr.sh/onboarding).
