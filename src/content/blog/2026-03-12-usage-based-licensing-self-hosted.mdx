...
slug: 'usage-based-licensing-self-hosted'
authors:
  - name: 'Louis Weston'
    role: 'Co-Founder'
...
image: src/assets/blog/2026-03-12-usage-based-licensing-self-hosted/thumb.png
tags:
  - Features
---
...
It works fully offline. It works in air-gapped clusters. The token travels with the deployment.
...
- [License Keys guide](/docs/guides/license-keys/) — including token injection for Docker, Helm, and registry-only deployments
- [Application Entitlements guide](/docs/guides/application-licenses/)
