...
When you're shipping [software to on-prem or customer-controlled environments](/glossary/on-premises-definition/), you don't control the infrastructure. That's the whole point. The customer runs it.
...
In Distr, the compatibility report gets attached directly to the application version as a [version resource](/docs/guides/kubernetes-compatibility-matrix/), visible to customers in their portal alongside the version details. They can check compatibility for their specific cluster version before they approve an upgrade. No emails. No back-and-forth.
