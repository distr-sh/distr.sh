...
This guide builds on top the [create a Docker application](/docs/guides/application/) and explains
...
<Aside type="caution">
  The Distr agent **does not** mount the `.env` file as file into your
