...
<Aside type="tip">
  ...
  [application entitlement](/docs/guides/application-licenses/) and assign it to
  the customer first
</Aside>
...
- [Application Entitlements](/docs/guides/application-licenses/) - Control which applications customers can access
