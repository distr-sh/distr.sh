...
Next steps: assign access with [Application Entitlements](/docs/guides/application-licenses/) or [Artifact Entitlements](/docs/guides/artifact-licenses/), or learn the [End-customer view of Distr](/docs/guides/container-registry-for-end-customers/).
