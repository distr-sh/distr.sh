...
Learn how to create and manage Application Entitlements in the [Application Entitlements guide](/docs/guides/application-licenses/).
...
Learn how to create and manage Artifact Entitlements in the [Artifact Entitlements guide](/docs/guides/artifact-licenses/).
...
<Aside type="note">
  **Deleting a license key does not revoke issued tokens.** JWTs are
  stateless — a token remains valid until its `expiresAt` date, regardless of
  whether the key still exists in Distr.
</Aside>

Learn how to create and manage License Keys in the [License Keys guide](/docs/guides/license-keys/).
